    ...
    <footer class="w-full py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                <a href="https://fastro.in/" class="flex justify-center ">
                    ...
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <Link to="https://www.instagram.com/fastro.in/" class="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                        ...
                        <Link to="https://www.youtube.com/@AlphaGaming18-f1l" class="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <span class="text-lg text-gray-500 text-center block">©<a href="https://fastro.in/">fastro.in</a> 2025, All rights reserved.</span>
            </div>
        </div>
    </footer>
